...
public class BinaryTreePrint   {
	...
	/*
	 * This method requires that there is a class binaryTree.BinaryTreeNode
	 ...
	 * binaryTree.BinaryTreeNode getLeftChild()) // return a reference to leftChild
	 * binaryTree.BinaryTreeNode getRightChild()) // return a reference to rightChild
	 * 
